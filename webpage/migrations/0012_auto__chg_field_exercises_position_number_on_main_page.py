...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercises.position_number_on_main_page'
        db.alter_column(u'webpage_exercises', 'position_number_on_main_page', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Exercises.position_number_on_main_page'
        db.alter_column(u'webpage_exercises', 'position_number_on_main_page', self.gf('django.db.models.fields.IntegerField')(default=None))
