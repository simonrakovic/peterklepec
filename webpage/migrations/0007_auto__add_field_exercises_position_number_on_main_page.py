...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercises.position_number_on_main_page'
        db.add_column(u'webpage_exercises', 'position_number_on_main_page',
                      self.gf('django.db.models.fields.IntegerField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercises.position_number_on_main_page'
        db.delete_column(u'webpage_exercises', 'position_number_on_main_page')
