...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Images.placedIn'
        db.delete_column(u'webpage_images', 'placedIn_id')
    ...
    def backwards(self, orm):
        # Adding field 'Images.placedIn'
        db.add_column(u'webpage_images', 'placedIn',
    ...
    models = {
        ...
        u'webpage.imageplacement': {
            ...
            'exercisesID': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webpage.Exercises']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'where_to_show': ('django.db.models.fields.IntegerField', [], {'default': 'None'})
        },
        u'webpage.images': {
            'Meta': {'object_name': 'Images'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'exercisesID': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webpage.ImagePlacement']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
