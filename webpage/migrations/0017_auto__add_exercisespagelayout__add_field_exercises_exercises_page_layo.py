...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExercisesPageLayout'
        db.create_table(u'webpage_exercisespagelayout', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'webpage', ['ExercisesPageLayout'])

        # Adding field 'Exercises.exercises_page_layout'
        db.add_column(u'webpage_exercises', 'exercises_page_layout',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['webpage.ExercisesPageLayout'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExercisesPageLayout'
        db.delete_table(u'webpage_exercisespagelayout')

        # Deleting field 'Exercises.exercises_page_layout'
        db.delete_column(u'webpage_exercises', 'exercises_page_layout_id')
